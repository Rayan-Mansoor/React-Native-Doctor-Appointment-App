export interface Doctor {
  ...
  const doctors: Doctor[] = [
    ...
    { id: 3, name: "ڈاکٹر سامنتھا جانسن", specialty: "Neurology", location: "لندن", image: require('../../assets/doctor3.png'), rating: 4.8, yearsExperience: 12, patients: 600, about: "نیورولوجیکل امراض کے علاج پر توجہ مرکوز کرنے والے نیورولوجسٹ۔" },
    ...
    { id: 13, name: "ڈاکٹر میا لیوس", specialty: "Neurology", location: "سان انتونیو", image: require('../../assets/doctor13.png'), rating: 4.8, yearsExperience: 11, patients: 600, about: "نیورولوجیکل حالات اور علاج میں ماہر نیورولوجسٹ۔" },
    ...
    { id: 20, name: "ڈاکٹر آئڈن بیکر", specialty: "Ophthalmology", location: "شارلٹ", image: require('../../assets/doctor20.png'), rating: 4.5, yearsExperience: 11, patients: 600, about: "جدید آنکھوں کی سرجریوں اور نظر کی اصلاح کی تکنیک میں ماہر آنکھوں کے ڈاکٹر۔" }
  ];
