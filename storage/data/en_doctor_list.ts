...
const doctors: Doctor[] = [
  ...
  { id: 3, name: "Dr. Samantha Johnson", specialty: "Neurology", location: "London", image: require('../../assets/doctor3.png'), rating: 4.8, yearsExperience: 12, patients: 600, about: "Neurologist with a focus on treating neurological disorders."},
  ...
  { id: 13, name: "Dr. Mia Lewis", specialty: "Neurology", location: "San Antonio", image: require('../../assets/doctor13.png'), rating: 4.8, yearsExperience: 11, patients: 600, about: "Neurologist with expertise in neurological conditions and treatments."},
  ...
  { id: 20, name: "Dr. Aiden Baker", specialty: "Ophthalmology", location: "Charlotte", image: require('../../assets/doctor20.png'), rating: 4.5, yearsExperience: 11, patients: 600, about: "Ophthalmologist specializing in advanced eye surgeries and vision correction techniques."},
];
