...
import { Text, View, StyleSheet, StyleProp, TextStyle, NativeSyntheticEvent, TextLayoutEventData } from 'react-native';
...
const TypeWriterEffect: React.FC<TypeWriterEffectProps> = ({
  ...
  const calculateNumberOfLines = (event: NativeSyntheticEvent<TextLayoutEventData>) => {
