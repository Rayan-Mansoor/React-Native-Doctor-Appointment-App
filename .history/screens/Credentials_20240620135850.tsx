...
function Credentials({ }) {
  ...
  const shakeAnimation = (animation: Animated.Value | Animated.ValueXY) => {
    Animated.sequence([
    ...
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        <Animated.View style={[
          ...
          { transform: [{ translateX: nameShakeAnimation }] }
        ]}>
          <TextInput
      ...
      <View style={styles.inputContainer}>
        <Animated.View style={[
          styles.input, 
          ageError ? styles.inputError : undefined, 
          { transform: [{ translateX: ageShakeAnimation }] }
        ]}>
          <TextInput
