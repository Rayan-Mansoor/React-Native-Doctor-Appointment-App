...
const Home = ({ navigation }: Props) => {
  ...
  // const pressTimestamp = useRef(0);

  // const handleVolumeButtonPress = (event) => {
  //   const currentTimeStamp = event.timeStamp;
  //   if (currentTimeStamp - pressTimestamp.current < 300) {
  //     // Volume button pressed twice in quick succession
  //     // Execute your function here
  //     console.log('Volume button pressed twice');
  //     // Reset the pressTimestamp
  //     pressTimestamp.current = 0;
  //   } else {
  //     // Update the pressTimestamp with the current time
  //     pressTimestamp.current = currentTimeStamp;
  //   }
  // };
  ...
  useEffect(() => {
    ...
    KeyEvent.onKeyMultipleListener((keyEvent: { keyCode: any; action: any; pressedKey: any; }) => {
