...
const getDisabledDates = (startDate: string, endDate: string, enabledDates) => {
  const dates = {};
...
const Appointment = () => {
  ...
  const [markedDates, setMarkedDates] = useState(getDisabledDates('2023-06-01', '2023-06-30', initialMarkedDates));
