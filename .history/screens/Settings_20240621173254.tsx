...
import { View, Text, StyleSheet, ScrollView, TextInput, TouchableOpacity, Switch, Button } from 'react-native';
...
const Settings = ({ navigation }: Props) => {
  ...
  const getNotificationState = () => {
    try {
      ...
      setNotificationsEnabled(false) // Default value if not found
    } catch (error) {
  ...
  const handleNotificationsChange = async (enabled: boolean) => {
    ...
    await saveNotificationState(enabled);
